...
EXP_ASM_merge:
  ...
  .ciclo:
      ...
      movdqu xmm5, xmm1
      punpcklwd xmm5, xmm14 ; xmm5 = | p1-0 |
      pxor xmm5, xmm5 ; xmm5 = | p1-0 | (float)
      movdqu xmm6, xmm2
      punpcklwd xmm6, xmm14 ; xmm6 = | p2-0 |
      pxor xmm6, xmm6 ; xmm6 = | p2-0 | (float)
      ...
      movdqu xmm7, xmm1
      punpckhwd xmm7, xmm14 ; xmm7 = | p1-1 |
      pxor xmm7, xmm7 ; xmm7 = | p1-1 | (float)
      movdqu xmm8, xmm2
      punpckhwd xmm8, xmm14 ; xmm8 = | p2-1 |
      pxor xmm8, xmm8 ; xmm8 = | p2-1 | (float)
      ...
      movdqu xmm9, xmm3
      punpcklwd xmm9, xmm14 ; xmm9 = | p1-2 |
      pxor xmm9, xmm9 ; xmm9 = | p1-2 | (float)
      movdqu xmm10, xmm4
      punpcklwd xmm10, xmm14 ; xmm10 = | p2-2 |
      pxor xmm10, xmm10 ; xmm10 = | p2-2 | (float)
      ...
      movdqu xmm11, xmm3
      punpckhwd xmm11, xmm14 ; xmm11 = | p1-3 |
      pxor xmm11, xmm11 ; xmm11 = | p1-3 | (float)
      movdqu xmm12, xmm4
      punpckhwd xmm12, xmm14 ; xmm12 = | p2-3 |
      pxor xmm12, xmm12 ; xmm12 = | p2-3 | (float)
      ...
      pxor xmm5, xmm5 ; xmm5 = | p1-0 * value + p2-0 * (1-value) | (enteros 32b)
      pxor xmm7, xmm7 ; xmm7 = | p1-1 * value + p2-1 * (1-value) | (enteros 32b)
      pxor xmm9, xmm9 ; xmm9 = | p1-2 * value + p2-2 * (1-value) | (enteros 32b)
      pxor xmm11, xmm11 ; xmm11 = | p1-3 * value + p2-3 * (1-value) | (enteros 32b)
