...
#define func_blur_size 9
#define func_size 9

static const char* files_path = "img/";
static const void (*func_blur[func_blur_size])(uint32_t w, uint32_t h, uint8_t* data) = {C_blur, ASM_blur1, ASM_blur2, EXP_C_blur1, EXP_C_blur2, EXP_C_blur3, EXP_ASM_blur3, EXP_ASM_blur4, EXP_ASM_blur5};
...
int main(void)
{
  ...
  fprintf(file, "img w h tam cblur asm1blur asm2blur expcblur1 expcblur2 expcblur3 expasm3 expasm4 expasm5\n");
  DIR *d;
  struct dirent *dir;
