...
; void EXP_ASM_blur5( uint32_t w, uint32_t h, uint8_t* data )
global EXP_ASM_blur5
extern malloc
extern free
...
EXP_ASM_blur5:
    ...
    .ciclo_fila:
        ...
        .ciclo_columna:
            ...
            paddw xmm9, xmm11 ; Sumas extra innecesarias 
            psubw xmm9, xmm11 
            paddw xmm9, xmm11 
            ...
            psubd xmm0, xmm6 ; cuentas innecesarias
            paddd xmm0, xmm6 
            paddd xmm1, xmm6
            paddd xmm1, xmm7 ; xmm1 = col2 + col3 + col4 = i2
            psubd xmm1, xmm7 ; cuentas innecesarias
            paddd xmm1, xmm7 
            paddd xmm6, xmm7
            paddd xmm6, xmm9 ; xmm6 = col3 + col4 + col5 = i3
            psubd xmm6, xmm9 ; cuentas innecesarias
            paddd xmm6, xmm9 
            paddd xmm7, xmm9
            paddd xmm7, xmm10 ; xmm7 = col4 + col5 + col6 = i4
            psubd xmm7, xmm10 ; cuentas innecesarias
            paddd xmm7, xmm10 
